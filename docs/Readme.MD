e-book from [Machine Learning Mastery](https://machinelearningmastery.com), Thankyou for jason brownlee for the e-books.
...
Machine Learning Cheatsheet.pdf -  Simple explanation of ML algorithms
